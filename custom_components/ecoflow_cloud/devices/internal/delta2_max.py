...
from custom_components.ecoflow_cloud.sensor import LevelSensorEntity, RemainSensorEntity, TempSensorEntity, \
    ...
    InEnergySensorEntity, OutEnergySensorEntity, SolarInPowerSensorEntity, \
...
class Delta2Max(BaseDevice):
    def sensors(self, client: EcoflowApiClient) -> list[BaseSensorEntity]:
        return [
            ...
            SolarInPowerSensorEntity(client, self, const.SOLAR_IN_POWER).with_energy(),
            ...
            # Solar In Energy is generated by the integration sensor attached to
            # the combined "Solar In Power" sensor (see SolarInPowerSensorEntity
            # .with_energy() above) - EcoFlow no longer sends pd.chgSunPower.
